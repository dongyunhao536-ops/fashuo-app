...
export const SUBJECT_METHOD: Record<string, string> = {
  ...
  法制史: `纯背"背多分"、命题最稳（史料引文+设问）。双线织网：朝代主线（一朝立法+司法）×制度纵线（五刑/会审等跨朝演变）；口诀标《考试分析》页边，隋唐(唐律疏议)/明清极高频优先，每周至少滚3次（遗忘最快）。做题：选择坑=张冠李戴（谁提出/哪朝/哪部律，四要素对齐）、材料分析=看引文认制度→释义→评价。★云专属：背多分性价比高、别因"靠后突破"就一直空着；第1轮先啃隋唐+明清两块极高频+其余混脸熟；"每周滚3次"是硬指标（正撞他"背了就忘/不复盘"病根，宁可勤滚别隔太久）。`,
};
