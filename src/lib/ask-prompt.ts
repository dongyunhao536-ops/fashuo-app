...
- search_xinde：查 做题心得 + 刑法/民法讲义心得（作者标注框）——最高优先级，先规划这个
- search_textbook：查《考试分析》教材 + 刑法/民法讲义原文——**《考试分析》是根本、必覆盖**；两者同在 textbook 库、同级，一次 search_textbook 就把考试分析和讲义一起扫到
...
① 心得文件 → ② 真题分析（高频考点）→ ③ 教材原文（《考试分析》与《精讲一本通》讲义〔刑法·车润海／民法·岳业鹏〕，同级权威）→ ④ 民法典/刑法条文 → ⑤ 司法解释。
