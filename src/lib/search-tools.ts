...
export const SEARCH_TOOLS: Anthropic.Tool[] = [
  {
    ...
    description:
      "在《考试分析》教材 + 《精讲一本通》讲义原文（刑法·车润海／民法·岳业鹏）中检索关键词，返回命中片段+行号。两者同级权威。回答概念辨析/法条理解/真题答案质疑前必须先调用，核对原文（v2.3 机制①⑨）。",
    input_schema: {
      type: "object",
      properties: {
  ...
  },
  {
    name: "search_xinde",
    description:
      "在各科做题心得 + 刑法/民法讲义心得（《精讲一本通》作者标注的提示/马工程/易错/辨析框，逐字提取，是作者划的重点/权威观点）中检索规则。答疑优先级第一档：心得/讲义心得已有规则则优先据此作答，引用讲义心得带上讲义页码。",
    input_schema: {
      type: "object",
      properties: {
