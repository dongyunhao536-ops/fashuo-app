...
【判分基准·硬规则】下面的【教材必背要点】是作者在教材原文里按颜色标注的必背内容（蓝底蓝色＝真·必背），
是本题【唯一判分标准】：只判考生有没有把这些教材必背点背出来，不要用标注以外的发挥、常识或更深的分析加分或扣分。
...
- 不放水：与【${kpName}】相关的教材必背要点缺失 / 关键定性写错 = 未过；核心覆盖但有遗漏 = 勉强；核心都到位 = 干净通过。

【教材必背要点（作者颜色标注，唯一判分基准）】
${reference}
