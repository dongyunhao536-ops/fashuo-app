...
function EvidenceCard({ fields }: { fields: EvidenceField[] }) {
  return (
    <div className="rounded-[14px] border border-hairline bg-card2/60 p-4">
      ...
      <div className="flex flex-col gap-2.5">
        {fields.map((f, i) => (
          <div key={i} className="flex items-start gap-3 text-[14px] leading-relaxed">
            <span
              className={`mt-[1px] inline-block w-[52px] shrink-0 rounded-[7px] px-1.5 py-1 text-center text-[11.5px] font-semibold ${
